...
void test_f() {
    ...
    assert(f({static_cast<int>(0xFFFFFFFF), 0, 0, static_cast<int>(0xFFFFFFFF)}) == 64);
    ...
    assert(f({
        ...
        static_cast<int>(0b00000000000000000000000000000000),
        static_cast<int>(0b00000000000000001110000000000000),
        static_cast<int>(0b00000000000000011111000000000000),
        static_cast<int>(0b00000000000000001110000000000000),
        static_cast<int>(0b00000000000000000000000000000000),
      }) == 9);
